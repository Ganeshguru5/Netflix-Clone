...
import Tvrecommends from '../components/Tvrecommends'

import { useParams } from 'react-router-dom'
import "../styles/HomeScreen.css"

export default function SelectTvshow() {
  const [trailerurl,seTrailerurl] = useState('')
  const {id} = useParams()
    
  fetch(`https://api.themoviedb.org/3/tv/${id}/videos?api_key=b02a8e9727484f1244028d52867cc576&language=en-US&type=trailer`)
...
/>
        ...
        <div>
          <Tvrecommends id={id} name={"Similar movies"}/>
